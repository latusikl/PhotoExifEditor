// copied from https://github.com/hMatoba/piexifjs

export type ExifFieldNames = '0th' | 'Exif' | 'Interop' | 'GPS' | '1st' | 'thumbnail';
...
export type TagsFieldNames = 'Image' | '0th' | 'Exif' | 'Interop' | 'GPS' | '1st';
